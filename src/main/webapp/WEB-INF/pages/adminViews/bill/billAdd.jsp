    ...
    <div class="right">
        ...
        <div class="providerAdd">
            <form action="#">
                ...
                <div>
                    <label for="billUser">下单人：</label>
                    <input type="text" name="billUser" id="billUser" required/>
                    <span >*请输入下单人姓名</span>
                </div>
                <div>
                    <label for="billAddress">派送地址：</label>
                    <input type="text" name="billAddress" id="billAddress" required/>
                    <span >*请输入派送地址</span>
                </div>
                <div>
